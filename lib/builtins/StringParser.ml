...
include Parser.Parser (StringParserInner) (StringInput)
open Utils
...
let lowercase = satisfies is_lowercase <!> "failed to match lowercase character"
let uppercase = satisfies is_uppercase <!> "failed to match uppercase character"
